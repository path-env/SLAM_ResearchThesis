...
\input{chapters/6_literature-review.tex}

% SLAM Formulation + State Prediction and correction
\chapter{Formulation}
\label{chap:Formulation}
\input{chapters/7_formulation.tex}

\chapter{Particle Filter}
\label{chap:Particle}
\input{chapters/8_particlefilterapproach.tex}

\chapter{Scan Matching}
\label{chap:Scan}
\input{chapters/9_scanmatching.tex}

\chapter{Comparison and Benchmarking}
\label{chap:Comparison}
\input{chapters/10_benchmarking.tex}

% Conclusions / Findings
\chapter{Conclusions}
\label{chap:Conclusions}
\input{chapters/11_conclusions.tex}
